...
- [Bench Harness Benchmarks](./spools/bench/README.md) (approved local-root spool; deterministic containerized coding-agent benchmarks with normalized metrics and a shuttle-served judge)
