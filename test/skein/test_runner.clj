...
(defn -main [& _]
  ...
  (let [{:keys [fail error]} (test/run-tests 'skein.alpha-test 'skein.client-test 'skein.config-test 'skein.weaver-test 'skein.db-test 'skein.shuttle-test 'skein.spools-test 'skein.spools.devflow-test 'skein.spools.workflow-test 'skein.plugin-test 'skein.relations-test 'skein.repl-test 'skein.runtime-deps-test)]
    (when (pos? (+ fail error))
      (System/exit 1))))
