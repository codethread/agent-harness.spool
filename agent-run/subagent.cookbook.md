...
engine](https://github.com/codethread/millhouse.spool/blob/3dcf93cf511c3a4412ee62ede92bd077f4ca6000/spools/workflow/README.md), which models a step it can't do itself as a `gate`, and the [agent-run
...
- **The gate is a pure-data run request.** Handing the run its whole configuration as attributes
  ...
  call, and gets out of the way. The [fan-out recipe](https://github.com/codethread/millhouse.spool/blob/3dcf93cf511c3a4412ee62ede92bd077f4ca6000/spools/workflow/workflow.cookbook.md#recipe-fan-out-over-a-collection-with-a-chained-loop)
...
- [`workflow.cookbook.md`](https://github.com/codethread/millhouse.spool/blob/3dcf93cf511c3a4412ee62ede92bd077f4ca6000/spools/workflow/workflow.cookbook.md) — the gate and fan-out recipes that author the
